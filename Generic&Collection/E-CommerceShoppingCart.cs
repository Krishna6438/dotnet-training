// Requirements
// Create generic Product<T> class
// Use Dictionary<T, int> for cart items (product → quantity)
// Implement discount calculation using Func<T, double, double>
// Use LINQ for cart analytics
// Tasks
// csharp
...
namespace ECommerceShoppingCart
{
    ...
    class EcommerceShoppingCartClass
    {
