// Requirements
// Create a generic Catalog<T> class that can store any type of item
// Use List<Book> for all books
// Use HashSet<string> for tracking ISBNs (ensure uniqueness)
// Use SortedDictionary<string, List<Book>> to organize books by genre
// Tasks
// csharp
