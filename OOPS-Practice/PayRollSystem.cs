...
namespace ItTechGenie.M1.OOP.Q2
{
    ...
    public sealed class Developer : Employee
    {
        ...
        public override decimal CalculateSalary()
        {
            ...
            decimal finalSalary = BasePay + (BasePay * 0.10m);
            return finalSalary;
    ...
    public sealed class Manager : Employee
    {
        ...
        public override decimal CalculateSalary()
        {
            ...
            return BasePay + 1500 + (BasePay * 0.05m);
        }
    }
    ...
    public static class EmployeeFactory
    {
        ...
        public static Employee Create(Command cmd)
        {
            ...
            string role = cmd.Get("role");
            string id = cmd.Get("id");
            string name = cmd.Get("name");
            decimal basePay = decimal.Parse(cmd.Get("base"));
            string extra = cmd.Get("extra");
